...
const Ford = () => {
  ...
  useEffect(() => {
      const targetS = targetData.filter(target => target?.brandName == 'FORD');
  ...
  <div id="slide1" className="carousel-item relative w-full">
    <img src="https://i.ibb.co/m0bpmZ6/ad-2-ford.png" className="w-full" />
  ...
  <div id="slide2" className="carousel-item relative w-full">
    <img src="https://i.ibb.co/VDSYdQ4/ad1-ford.png" className="w-full" />
  ...
  <div id="slide3" className="carousel-item relative w-full">
    <img src="https://i.ibb.co/gSRXZjH/ad3-ford.png" className="w-full" />
