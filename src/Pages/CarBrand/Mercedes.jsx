...
const Mercedes = () => {
  ...
  useEffect(() => {
      const targetS = targetData.filter(target => target?.brandName == 'MERCEDES-BENZ');
 ...
 <div id="slide1" className="carousel-item relative w-full">
   <img src="https://i.ibb.co/svc5pS5/Mercedes-Benz-Ads-1.png" className="w-full" />
 ...
 <div id="slide2" className="carousel-item relative w-full">
   <img src="https://i.ibb.co/PT8fZ8R/Mercedes-Benz-Ads-2.png" className="w-full" />
 ...
 <div id="slide3" className="carousel-item relative w-full">
   <img src="https://i.ibb.co/fxrFLSm/Mercedes-Benz-Ads-3.png" className="w-full" />
