...
const Footer = () => {
  ...
  <nav className='flex'>
    ...
    <ul className='text-white text-base'>
      ...
      <li><a className="link link-hover">* Company</a></li>
     ...
     <li className='ml-64'><a href='https://www.facebook.com/akmazharabrartinni/' alt=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a></li>
    ...
    <fieldset className="form-control w-80"> 
     ...
     <p className='ml-36 mt-3 font-serif'><a className='text-yellow-400 font-semibold text-xl'>The Wheels Of Abrar Enterprise.</a> <br/><a className='text-white text-base'>Providing Your Reliable Dream Ride since 2022 <br/> &copy; {new Date().getFullYear()} - All Right Reserved by Azhar</a></p>
     </ul>
